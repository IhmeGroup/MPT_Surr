function draw_both_2d(P,Ell,Ell_AA,x0_R,diff_R,x0_out,diff_out,exp_comp,palette_label,save_output)
...
% DRAW HYPERCUBOIDS
inner = rectangle('Position',[x0_R(idx_1)-diff_R(idx_1) x0_R(idx_2)-diff_R(idx_2) 2*diff_R(idx_1) 2*diff_R(idx_2)],'LineWidth',4);
